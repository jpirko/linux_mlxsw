...
static inline int mr_vif_notifier_call(struct notifier_block *nb,
				       struct net *net,
...
static inline int mr_vif_notifiers_call(struct net *net,
					unsigned short family,
					enum fib_event_type event_type,
					struct vif_device *vif,
					unsigned short vif_index, u32 tb_id,
...
static inline int mr_mfc_notifier_call(struct notifier_block *nb,
				       struct net *net,
				       unsigned short family,
				       enum fib_event_type event_type,
...
static inline int mr_mfc_notifiers_call(struct net *net,
					unsigned short family,
					enum fib_event_type event_type,
					struct mr_mfc *mfc, u32 tb_id,
					unsigned int *ipmr_seq)
