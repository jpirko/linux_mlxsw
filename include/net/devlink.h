...
#define DEVLINK_TRAP_GENERIC_NAME_UC_EMPTY_TX_LIST_DROP "uc_empty_tx_list_drop"
#define DEVLINK_TRAP_GENERIC_NAME_MC_EMPTY_TX_LIST_DROP "mc_empty_tx_list_drop"
