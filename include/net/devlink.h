 ...
 * @timestamp: Trap can provide timestamp
 ...
 * @init_state: Initial trap group state
...
enum devlink_trap_generic_id {
	...
	DEVLINK_TRAP_GENERIC_ID_EMPTY_TX_LIST_DROP,
	DEVLINK_TRAP_GENERIC_ID_LOOPBACK_FILTER_DROP,
...
#define DEVLINK_TRAP_GENERIC_NAME_INGRESS_SMAC_MC_DROP "ingress_smac_mc_drop"
...
#define DEVLINK_TRAP_GENERIC_NAME_EMPTY_TX_LIST_DROP "empty_tx_list_drop"
#define DEVLINK_TRAP_GENERIC_NAME_LOOPBACK_FILTER_DROP "loopback_filter_drop"
#define DEVLINK_TRAP_GENERIC_NAME_BLACKHOLE_ROUTE_DROP "blackhole_route_drop"
#define DEVLINK_TRAP_GENERIC_NAME_TTL_ERROR_EXCEPTION "ttl_error_exception"
#define DEVLINK_TRAP_GENERIC_NAME_TAIL_DROP "tail_drop"
#define DEVLINK_TRAP_GENERIC_NAME_EARLY_DROP "early_drop"
