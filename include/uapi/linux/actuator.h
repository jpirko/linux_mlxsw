...
enum actuator_type {
	...
	ACTUATOR_TYPE_ROTARY,
};

enum actuator_units {
	ACTUATOR_UNITS_UNSPEC,
	ACTUATOR_UNITS_UM, /* micrometres */
	ACTUATOR_UNITS_PERCENT, /* for example for DC motors */
	ACTUATOR_UNITS_STEPS, /* for example for stepper motors */
};
...
enum actuator_attr {
	...
	ACTUATOR_ATTR_VECTOR,		/* nest */
	ACTUATOR_ATTR_VECTOR_TEMPLATES,	/* nest */
...
enum actuator_vector_attr {
	/* don't change the order or add anything between, this is ABI! */
	ACTUATOR_ATTR_VECTOR_UNSPEC,

	ACTUATOR_ATTR_VECTOR_MOVE,	/* flag */
	ACTUATOR_ATTR_VECTOR_STOP,	/* flag */
	ACTUATOR_ATTR_VECTOR_VALUE,	/* u32, in units */
	ACTUATOR_ATTR_VECTOR_INC_VALUE,	/* u32, in units */
	ACTUATOR_ATTR_VECTOR_DIR,	/* u8, enum actuator_dir */
	ACTUATOR_ATTR_VECTOR_SPEED,	/* u32, in units per second */

	/* add new attributes above here, update the policy in actuator.c */

	__ACTUATOR_ATTR_VECTOR_MAX,
	ACTUATOR_ATTR_VECTOR_MAX = __ACTUATOR_ATTR_VECTOR_MAX - 1
};
