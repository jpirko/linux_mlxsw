...
/**
 * enum devlink_trap_report - Packet trap report state
 * @DEVLINK_TRAP_REPORT_OFF: Do not report trapped packet to user space
 * @DEVLINK_TRAP_REPORT_ON: Report trapped packet to user space
 */
enum devlink_trap_report {
	DEVLINK_TRAP_REPORT_OFF,
	DEVLINK_TRAP_REPORT_ON,
};
 ...
 * @DEVLINK_TRAP_TYPE_DROP: Trap reason is a drop
 * @DEVLINK_TRAP_TYPE_EXCEPTION: Trap reason is an exception. Packet was not
 *                               forwarded as intended due to an exception
 *                               (e.g., missing neighbour entry) and trapped to
 *                               control plane for resolution.
 */
