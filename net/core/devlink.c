				     ...
				     const struct devlink_trap *trap)
{
	...
	if (trap->metadata_in_port &&
	    nla_put_flag(msg, DEVLINK_ATTR_TRAP_METADATA_TYPE_IN_PORT))
		goto nla_put_failure;

	if (trap->metadata_timestamp &&
 ...
 *
 * The names of the traps are part of the kernel ABI and must have a
 * corresponding entry under Documentation/ABI/.
 *
 ...
 *
 * The names of the trap groups are part of the kernel ABI and must have a
 * corresponding entry under Documentation/ABI/.
 *
 * Return: Non-zero value on failure.
 */
