...
{
	return mr_vif_notifier_call(nb, net, RTNL_FAMILY_IPMR, event_type,
				    vif, vif_index, tb_id);
}
...
static int call_ipmr_vif_entry_notifiers(struct net *net,
					 ...
					 vifi_t vif_index, u32 tb_id)
{
	return mr_vif_notifiers_call(net, RTNL_FAMILY_IPMR, event_type,
				     vif, vif_index, tb_id,
				     &net->ipv4.ipmr_seq);
}
...
{
	return mr_mfc_notifier_call(nb, net, RTNL_FAMILY_IPMR,
...
static int call_ipmr_mfc_entry_notifiers(struct net *net,
					 ...
					 struct mfc_cache *mfc, u32 tb_id)
{
	return mr_mfc_notifiers_call(net, RTNL_FAMILY_IPMR, event_type,
