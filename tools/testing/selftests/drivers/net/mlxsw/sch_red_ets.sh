...
# __ecn_test first build 2/3 of the requested backlog and expects no marking,
...
ecn_test()
{
	...
	__ecn_test 10 $BACKLOG1
	__ecn_test 11 $BACKLOG2
...
red_test()
{
	...
	__red_test 10 $BACKLOG1
	__red_test 11 $BACKLOG2
