...
ecn_mirror_test()
{
	install_qdisc qevent mark block 10
	do_ecn_mirror_test 10 $BACKLOG
	uninstall_qdisc
}

red_mirror_test()
{
	install_qdisc qevent early block 10
	do_red_mirror_test 10 $BACKLOG
	uninstall_qdisc
}

ecn_red_mirror_test()
{
	install_qdisc qevent mark block 10 qevent early block 10
	do_ecn_mirror_test 10 $BACKLOG
	do_red_mirror_test 10 $BACKLOG
	uninstall_qdisc
}
