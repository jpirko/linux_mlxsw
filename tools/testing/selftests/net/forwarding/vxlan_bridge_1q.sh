...
test_learning()
{
	...
	# Enable learning on the VxLAN devices and set ageing time to 15 seconds
	ip link set dev br1 type bridge ageing_time 1500
	ip link set dev vx10 type vxlan ageing 15
	ip link set dev vx10 type vxlan learning
	ip link set dev vx20 type vxlan ageing 15
