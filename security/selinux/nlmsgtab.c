...
static const struct nlmsg_perm nlmsg_route_perms[] =
{
	...
	{ RTM_NEWQEVENT,	NETLINK_ROUTE_SOCKET__NLMSG_WRITE },
	{ RTM_DELQEVENT,	NETLINK_ROUTE_SOCKET__NLMSG_WRITE },
	{ RTM_GETQEVENT,	NETLINK_ROUTE_SOCKET__NLMSG_READ  },
};
...
int selinux_nlmsg_lookup(u16 sclass, u16 nlmsg_type, u32 *perm)
{
	...
	case SECCLASS_NETLINK_ROUTE_SOCKET:
		 ...
		 */
		BUILD_BUG_ON(RTM_MAX != (RTM_NEWQEVENT + 3));
