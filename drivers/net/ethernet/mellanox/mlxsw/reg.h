...
/* PPLR - PPLR - Port Physical Loopback Register
 * ---------------------------------------------
 * This register allows configuration of the port'. loopback mode.
 */
#define MLXSW_REG_PPLR_ID 0x5018
#define MLXSW_REG_PPLR_LEN 0x8

MLXSW_REG_DEFINE(pplr, MLXSW_REG_PPRL_ID, MLXSW_REG_PPLR_LEN);
...
enum mlxsw_reg_pplr_lb_type_bit {
	MLXSW_REG_PPLR_LB_TYPE_BIT_PHY_LOCAL = 0x01,
};
...
static inline void mlxsw_reg_pplr_pack(char *payload, u8 local_port, bool phy_local)
{
	MLXSW_REG_ZERO(pplr, payload);
	mlxsw_reg_pplr_local_port_set(payload, local_port);
	mlxsw_reg_pplr_lb_en(payload, phy_local ?
