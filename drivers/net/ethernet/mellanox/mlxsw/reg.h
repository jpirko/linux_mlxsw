					 ...
					 u16 local_port)
{
	...
	if (vid) {
		mlxsw_reg_sfd_uc_set_vid_set(payload, rec_index, true);
					 ...
					 u16 fid, bool irif_v, u16 irif)
{
	...
	mlxsw_reg_svfa_irif_set(payload, irif);
}
 ...
 * Access: RW
 *
 * Note: Reserved when legacy bridge model is used, when flood_rsp=1 and for
 * Spectrum-1.
 */
 ...
 * Access: RW
 *
 * Note: Reserved when legacy bridge model is used and for Spectrum-2.
 */
 ...
 * Access: RW
 *
 * Note: Reserved when legacy bridge model is used and for Spectrum-1.
 */
