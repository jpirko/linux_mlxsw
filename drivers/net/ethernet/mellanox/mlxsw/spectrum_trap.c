...
#define MLXSW_SP_TRAP_GROUP_DRIVER(_id, _policer_id)			      \
	DEVLINK_TRAP_GROUP_DRIVER(DEVLINK_MLXSW_TRAP_GROUP_ID_##_id,	      \
				  DEVLINK_MLXSW_TRAP_GROUP_NAME_##_id,	      \
				  _policer_id)
...
mlxsw_sp_trap_policer_items_arr[] = {
	...
	{
		.policer = MLXSW_SP_TRAP_POLICER(19, 10 * 1024, 128),
	}
};
...
mlxsw_sp2_trap_group_items_arr[] = {
	{
		.group = DEVLINK_TRAP_GROUP_GENERIC(BUFFER_DROPS, 19),
