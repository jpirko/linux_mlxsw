...
static struct devlink_trap mlxsw_sp_traps_arr[] = {
	...
	MLXSW_SP_TRAP_DROP(IPV4_DIP_UNSPECIFIED, L3_DROPS),
};
...
static struct mlxsw_listener mlxsw_sp_listeners_arr[] = {
	...
	MLXSW_SP_RXL_EXCEPTION(RTR_EGRESS0, REMOTE_ROUTE, TRAP_TO_CPU),
...
static u16 mlxsw_sp_listener_devlink_map[] = {
	...
	DEVLINK_TRAP_GENERIC_ID_IPV4_DIP_UNSPECIFIED,
};
