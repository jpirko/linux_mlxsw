					      ...
					      struct netlink_ext_ack *extack)
{
	...
	info = vxlan_fdb_switchdev_notifier_info(vxlan, fdb, rd, extack);
		      ...
		      struct switchdev_notifier_vxlan_fdb_info *fdb_info)
{
	...
	*fdb_info = vxlan_fdb_switchdev_notifier_info(vxlan, f, rdst, NULL);
				...
				struct netlink_ext_ack *extack)
{
	...
	fdb_info = vxlan_fdb_switchdev_notifier_info(vxlan, f, rdst, extack);
