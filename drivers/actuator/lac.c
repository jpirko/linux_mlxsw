...
static int lac_actuator_vector_get(struct actuator *act,
				   struct actuator_vector *act_vector)
{
...
static int lac_actuator_move(struct actuator *act,
			     struct actuator_vector *vector)
{
	...
	lac->msg.value = actuator_vector_value_get(vector);
	mutex_lock(&lac->lock);
...
static const struct actuator_vector_set_op lac_actuator_vector_set_ops[] = {
...
static const struct actuator_ops lac_actuator_ops = {
	...
	.vector_get = lac_actuator_vector_get,
	.vector_set_ops = lac_actuator_vector_set_ops,
	.vector_set_ops_count = ARRAY_SIZE(lac_actuator_vector_set_ops),
};
