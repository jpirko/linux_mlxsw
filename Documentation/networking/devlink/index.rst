...
Some objects, like linecards or port function, could have another
...
sure to respect following rules:
 ...
 - Lock ordering should be maintained. If driver needs to take instance
   lock of both nested and parent instances need to be taken at the same
   time, devlink instance lock of the nested instance should be always
   taken within the lock of the parent instance.
 - Driver should use object-specific helpers to setup the nested link:
